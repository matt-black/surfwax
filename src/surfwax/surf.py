...
from .haar import haar_response_2d, haar_response_3d
from .hessian import hessian_determinant_2d, hessian_determinant_3d
from .types import (
    Coord2D,
    Coord3D,
    Image,
...
__all__ = ["upright_surf_2d", "upright_surf_3d"]
...
def _extract_descriptor_window_3d(
    ...
    """_extract_descriptor_window_3d extracts cuboid region around a keypoint.
...
def _split_descriptor_window_3d(
    ...
    """_split_descriptor_window_3d Divides the descriptor window into a 3D grid of subregions.
